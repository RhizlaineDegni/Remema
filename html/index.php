...
try {
    $conn = new PDO("sqlsrv:server = tcp:remema-sqlsrv.database.windows.net,1433; Database = libraire", "rememauser", "{your_password_here}");
...
$connectionInfo = array("UID" => "rememauser", "pwd" => "{your_password_here}", "Database" => "libraire", "LoginTimeout" => 30, "Encrypt" => 1, "TrustServerCertificate" => 0);
$serverName = "tcp:remema-sqlsrv.database.windows.net,1433";
